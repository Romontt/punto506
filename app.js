    ...
    setTimeout(() => {
        grid.innerHTML = listaFiltrada.map((n, i) => {
            ...
            const badgeMenu = esPremium ? `
                <div class="absolute bottom-0 right-4 z-20 flex items-center gap-1.5 px-2.5 py-1.5 rounded-t-sm border-t border-x border-[#d4a373]/30 bg-[#130f0e] shadow-[0_-4px_10px_rgba(212,163,115,0.15)] transition-all duration-500 group-hover:px-4">
