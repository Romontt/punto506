...
function verDetalle(id) {
   ...
   target="_blank" 
   onclick="gtag('event', 'contact', { 'method': 'WhatsApp', 'business_name': '${n.nombre}' })"
               ...
               <a href="${n.instagram || '#'}" 
   target="_blank" 
   onclick="gtag('event', 'contact', { 'method': 'Instagram', 'business_name': '${n.nombre}' })"
   class="w-14 h-14 flex items-center justify-center border border-[#d4a373]/30 text-[#d4a373] hover:bg-[#d4a373] hover:text-[#130f0e] transition-all duration-500">
    <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2.163c3.204 0 3.584.012 4.85.07..."></path></svg>
</a>
