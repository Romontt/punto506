...
function renderLanding() {
    ...
    const categoriasConfig = [
        ...
        { id: 'gastronomía', nombre: 'Gastronomía', img: 'https://unsplash.com/photos/a-table-topped-with-lots-of-plates-of-food-hatqfX3b9Vo' },
        ...
        <div class="p-8 md:p-12 -mt-10 relative z-10 bg-[#1c1614]">
            ...
            <div class="flex justify-center gap-6 mb-12">
                <a href="https://api.whatsapp.com/send?phone=${n.whatsapp}&text=${mensajeWA}" target="_blank" 
                   class="w-14 h-14 flex items-center justify-center border border-[#d4a373]/30 text-[#d4a373] hover:bg-[#d4a373] hover:text-[#130f0e] transition-all duration-500" title="WhatsApp">
                ...
                <a href="${n.instagram || '#'}" target="_blank" 
                   class="w-14 h-14 flex items-center justify-center border border-[#d4a373]/30 text-[#d4a373] hover:bg-[#d4a373] hover:text-[#130f0e] transition-all duration-500" title="Instagram">
                ...
                <a href="${mapsUrl}" target="_blank" 
                   class="w-14 h-14 flex items-center justify-center border border-[#d4a373]/30 text-[#d4a373] hover:bg-[#d4a373] hover:text-[#130f0e] transition-all duration-500" title="Cómo Llegar">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7l5-2.5 5.553 2.776a1 1 0 01.447.894v10.764a1 1 0 01-1.447.894L14 17l-5 3z" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
                </a>
            </div>
