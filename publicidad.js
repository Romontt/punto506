...
(function() {
    // 1. Inyección de Estilos (Encapsulados para no chocar con tu CSS)
    ...
    style.innerHTML = `
        ...
        .amazon-wa-link:hover { background: #e68a00; }
    ...
    const amazonHTML = `
        <div id="amazon-floating-container">
            <div class="amazon-tooltip">¿Ocupas algo de Amazon? 📦</div>
        ...
        <div id="amazon-modal-overlay" onclick="closeAmazonModal(event)">
            <div class="amazon-modal-card">
                <h2 style="color:#ff9900; font-size: 24px; margin-bottom: 10px;">Trae tus Insumos</h2>
                <p style="font-size: 14px; line-height: 1.5; color: #aaa;">
                    Te ayudamos a cotizar y traer repuestos, herramientas o cualquier equipo de Amazon para tu negocio en Guápiles.
                </p>
                ...
                <button onclick="document.getElementById('amazon-modal-overlay').style.display='none'" style="background:none; border:none; color:#777; cursor:pointer; font-size:13px;">Tal vez luego</button>
            </div>
        </div>
    `;
